export const chemistrycycleece= (fourHourSubject,oneHourSubject) => {
    ...
    let totalecedepartmentccycle=[];
    totalecedepartmentccycle.push(timetableStructureOfeceA)
    totalecedepartmentccycle.push(timetableStructureOfeceB)
    return totalecedepartmentccycle;
