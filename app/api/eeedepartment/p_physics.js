export const physicscycleeee= (fourHourSubject,oneHourSubject) => {
    ...
    timetableStructureOfeeeA[1][4] = fourHourSubjects[0];
    ...
    timetableStructureOfeeeA[2][2] = fourHourSubjects[4];
    timetableStructureOfeeeA[2][4] = fourHourSubjects[0];
    timetableStructureOfeeeA[2][3] = fourHourSubjects[1];
    timetableStructureOfeeeA[3][4] = fourHourSubjects[2];
    ...
    timetableStructureOfeeeA[4][1] = oneHourSubjects[1];
    ...
    timetableStructureOfeeeB[0][1] = fourHourSubjects[0];
    ...
    timetableStructureOfeeeB[2][1] = fourHourSubjects[4];
