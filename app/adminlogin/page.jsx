        ...
        <div className='flex justify-center items-center  h-full w-full pt-[5%] pb-5 absolute top-0 left-0'>
            <div className='flex flex-col w-[450px] bg-[#000000bc] font-medium px-5 py-10 text-[#f5f5f5] asushad rounded-md gap-7'>
                ...
                <div className='flex flex-col gap-3'>
                    <div>Admin Name: </div>
                    <input className='bg-[#ffffff25] rounded-md px-2 py-4 text-[16px]' type="text" name="" id="" placeholder='Enter your name' />
                </div>

                <div className='flex flex-col gap-3 '>
                    <div>Password: </div>
                    <form className='relative flex items-center'>
                        <input className='bg-[#ffffff25] rounded-md px-2 py-4 text-[16px] w-full' type={`${shopass ? 'text' : 'password'}`} name="" id="" placeholder='Enter the secret key' />
                ...
                <Link href={'/admin'} className=''>
                    <button className='bg-[#ffffff25] rounded-md px-6 py-3 text-[16px] hover:bg-[#ffffff] hover:text-[#000000] smooth font-bold'>Log in</button>
                </Link>
            </div>
        </div>
    )
