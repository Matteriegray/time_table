          ...
          <div key={index} className="timetable-section">
            ...
            {timetable.map((week, weekIndex) => (
              <div key={weekIndex} className='justify-center items-center w-[100%] py-7 px-14'>
                <div className="week flex flex-col justify-center items-center border-2 border-[#ffffff] rounded-lg p-5 bg-[#ffffff35] text-[#fff]">
                  <h3 className="font-bold pb-4">{classes[weekIndex]}</h3>
                  <table className="timetable-table w-[90%] flex flex-col">
                    <thead className='mb-2'>
                      <tr className='flex justify-evenly gap-2'>
                        <th className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffff] text-[#000]'>Day</th>
                        <th className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffff] text-[#000]'>8-10:30</th>
                        <th className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffff] text-[#000]'>11-12:40</th>
                        <th className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffff] text-[#000]'>12:40-2:20</th>
                        <th className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffff] text-[#000]'>2:40-5:15</th>
                      </tr>
                    </thead>
                    <tbody className='flex flex-col gap-2'>
                      {week.map((day, dayIndex) => (
                        <tr key={dayIndex} className='flex justify-evenly gap-2'>
                          <td className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffffef] text-[#000]'>{day[0]}</td>
                          <td className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffffef] text-[#000]'>{day[1]}</td>
                          <td className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffffef] text-[#000]'>{day[2]}</td>
                          <td className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffffef] text-[#000]'>{day[3]}</td>
                          <td className='w-1/5 text-center border-[#000000] border-2 rounded-md py-1 bg-[#ffffffef] text-[#000]'>{day[4]}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
